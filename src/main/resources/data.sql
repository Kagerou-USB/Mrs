...
INSERT INTO usr (user_id, first_name, last_name, password, role_name) VALUES('taro-yamada', '太郎', '山田', '$2a$10$oxSJl.keBwxmsMLkcT9lPeAIxfNRPNQxpeywMrF7A3kVszwUTqfTK', 'USER');
-- 認証確認用のテストユーザー（password = demo）
-- ダミーユーザー（password = demo）
INSERT INTO usr (user_id, first_name, last_name, password, role_name) VALUES('aaaa', 'Aaa', 'Aaa', '$2a$10$oxSJl.keBwxmsMLkcT9lPeAIxfNRPNQxpeywMrF7A3kVszwUTqfTK', 'USER');
-- ダミーユーザー（password = demo）
INSERT INTO usr (user_id, first_name, last_name, password, role_name) VALUES('bbbb', 'Bbb', 'Bbb', '$2a$10$oxSJl.keBwxmsMLkcT9lPeAIxfNRPNQxpeywMrF7A3kVszwUTqfTK', 'USER');
-- ダミーユーザー（password = demo）
INSERT INTO usr (user_id, first_name, last_name, password, role_name) VALUES('cccc', 'Ccc', 'Ccc', '$2a$10$oxSJl.keBwxmsMLkcT9lPeAIxfNRPNQxpeywMrF7A3kVszwUTqfTK', 'ADMIN');