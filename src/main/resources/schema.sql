...
CREATE TABLE IF NOT EXISTS reservable_room (
	...
	FRIMARY KEY (reserved_date, room_id)
};
...
ALTER TABLE reservation_room ADD CONSTRAINT IF FK_f4wnx2qj0d59s9tl1q5800fw7 FOREIGN KEY (room_id) REFERENCES meeting_room;
